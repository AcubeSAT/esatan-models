...
# ESATAN-TMS 2020, run date 15:45 Tue 25 May 2021
# Model name: AcubeSAT__Model        Analysis case: Hot_6LTAN_Nominal_Nadir_600
#
  $LOCALS
...
C
      ...
      RELXCA=0.01
      DTIMEI=0.1
      CALL SOLCYC('SLCRNC',0.05D0,0.01D0,5801.24D0,60,' ','ALL')
C
      CALL SLCRNC
C
